...
export default function Create({ customer }: CreateProps) {
                ...
                <div className="max-w-2xl mx-auto mt-4">
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div className="px-6 py-5 border-b border-gray-100 flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-semibold text-gray-900">Add Port</h1>
                                <p className="text-sm text-gray-500 mt-0.5">Create a new port for <b>{customer.name}</b></p>
                            </div>
                        </div>
                            ...
                            <div className="p-6 space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Enter port name (e.g. PORT KLANG)"
